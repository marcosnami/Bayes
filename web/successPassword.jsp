...
<%
	String resetPassword = (String)session.getAttribute("password");
	String username = (String)session.getAttribute("username");
	String email = (String)session.getAttribute("email");
	//System.out.println("Username: " + username + " Password: " + resetPassword + " Email: " + email);
	if (resetPassword == null || username == null || email == null) {
		%>
...
<div class="bayes-message text-center">
	...
	<p>The new password was emailed to you on the email address provided.</p>
	<p>Please, make sure to change you password when you login.</p>
